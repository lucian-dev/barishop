...
jQuery(function ($) {
  ...
  var heroSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".hero-home__slider", swiperOptions);
  ...
  $(document).on("click", ".plus", function (e) {
    ...
    if (val) {
      if (parseFloat(val) >= 1) {
        ...
        $(this).parents(".quantity").find("input.qty").val(newVal).trigger("change");
      }
    } else {
      var oldVal = 0;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkyabu"] = self["webpackChunkyabu"] || [];
